...
//    // this are representing the size of an face
//    public static final int largeur_min = 15;
//    public static final int hauteur_min = 15;
//
//
//
//    // here is where the face will be
//    private Dessin d;
//
//    // this are representing the higth size of face
//    private int xhg = 0; // left-top (coin superieur gauche)
//    private int yhg = 0; // left-top (coin superieur gauche)
//
//
//    // face hight by pixel
...
//
//
//    private int dx = 5;  // deplacement aleatoire du visage selon l'axe horizontal
//
//
//
//    private int dy = 5; // deplacement aleatoire du visage selon l'axe vertical
//
...
//        hauteur = Math.min(haut, hauteur_min);
//    }
...
//
//
//    // inverse sens de deplacement horizontal
...
//    }
//
//    // inverser sens des deplacement horizontal et vertical
